...
/**
 * ✏️ PUT /api/admin/questions - Update existing question
 * Note: This handles both /api/admin/questions/{id} and /api/admin/questions with id in body
 */
async function updateQuestion(req, res) {
  // Extract ID from URL path or request body
  const pathParts = req.url.split('/');
  const idFromPath = pathParts[pathParts.length - 1];
  const id = !isNaN(idFromPath) ? parseInt(idFromPath) : req.body.id;
...
/**
 * 🗑️ DELETE /api/admin/questions - Delete question
 */
